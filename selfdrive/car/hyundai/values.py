...
class SteerLimitParams:
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.SONATA, CAR.PALISADE, CAR.GRANDEUR_HEV_19]:
      self.STEER_MAX = 384
    else:
      self.STEER_MAX = 255
...
FEATURES = {
  ...
  "use_elect_gears": set([CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.IONIQ, CAR.GRANDEUR_HEV_19]),
  ...
  "use_bsm": set([CAR.SONATA, CAR.PALISADE, CAR.HYUNDAI_GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.KONA, CAR.GRANDEUR_HEV_19]),
}

EV_HYBRID = set([CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.GRANDEUR_HEV_19])
